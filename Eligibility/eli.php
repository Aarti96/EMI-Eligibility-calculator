...
<div class="tab-content col-md-10">
		...
		function eligiable()
        {
				...
				var income = document.formval2.NetIncome.value;
				var income1=(income*75/100)-existing;
				/* if (income1<=14999){
				...
				var incomereq=Math.floor(income1 / emi1 * P1);
		...
		function bank1()
			{
				var bank=document.formval2.banks.value;
				switch(bank)
				{
					case "sbi":
						document.formval2.int_rate2.value=7.90;
					break;

					case  "icici":
						document.formval2.int_rate2.value=8.25;
					break;

					case "hdfc":
						document.formval2.int_rate2.value=8.05;
					break;
					...
					case "axis":
						document.formval2.int_rate2.value=8.55;
						break;
					default:
					document.formval2.int_rate2.value=9;
					break;
				...
				<form name="formval2" class="form-horizontal col-md-8" style="font-size:12px;">
					...
					<div class="form-group">
						<label for="input" class="col-sm-4 control-label">Banks </label>
						
					<div class="col-sm-8">
							<select name="banks" class="form-control input-sm" onchange="bank1()">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<div class="input-group">
						<input type="number" class="form-control input-sm" id="input" disabled name="int_rate2">
						<span class="input-group-addon">%</span>
						</div>
						</div>
					</div>
